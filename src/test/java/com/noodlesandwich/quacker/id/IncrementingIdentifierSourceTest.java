...
public class IncrementingIdentifierSourceTest {
    ...
    @Test public void
    starts_at_1() {
        assertThat(idSource.nextId(), is(1));
    }

    @Test public void
    increments_by_one_each_time() {
        assertThat(idSource.nextId(), is(1));
        assertThat(idSource.nextId(), is(2));
        assertThat(idSource.nextId(), is(3));
        assertThat(idSource.nextId(), is(4));
        assertThat(idSource.nextId(), is(5));
    }
}
